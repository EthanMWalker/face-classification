...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar 24 12:46:27 2021
...
def test_finetune():
  ...
  tuneset = datasets.ImageFolder('labelled', transform=transform)
  ...
  model, losses = simclr.fine_tune(data, 'chkpt/face_recognition-tune-test.tar', n_epochs=10)
